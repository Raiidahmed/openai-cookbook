...
with open("climate_tech_eventbrite_climate.csv", "r", encoding="UTF-8") as f:
    text = f.read()

# Create a DataFrame with 'fname' and 'text' columns
df = pd.DataFrame([{"fname": "climate_tech_eventbrite_climate.csv", "text": text}])
